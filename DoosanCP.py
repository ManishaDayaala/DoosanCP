...
MAINFOLDER = r"./APPdata_DoosanCP"

# Create other paths relative to the main folder
training_file_path = os.path.join(MAINFOLDER, "Training", "Training_DoosanCP.xlsx")  # FIXED TRAINING DATA
test_file_path = os.path.join(MAINFOLDER, "24hrData", "Dailydata_DoosanCP.xlsx")  # DAILY DATA
excel_file_path = os.path.join(MAINFOLDER, "Breakdownrecords_DoosanCP.xlsx")  # Recording excel for BD
folderpath = os.path.join(MAINFOLDER, "TemporaryData")  # Temporary dump files collector
threshold_file_path = os.path.join(MAINFOLDER,"Thresholds_DoosanCP.xlsx") 
...
st.markdown(
    ...
    <div style="display: flex; align-items: center;">
        ...
        <span style="font-size: {title_font_size}px; font-weight: bold;">Breakdown Predictor-Doosan(CP)</span>
    </div>
...
def process_all_files():
    ...
    assets_list = [
        "Doosan M15 GB IP DE","Doosan M15 GB OP DE","Doosan M15 MDE",
        "Doosan M15 Spindle DE","Doosan M15 Spindle NDE"]
